...
namespace ContainerExpressions.Expressions.Core
{
    internal static class ComposeAsync
    {
        ...
        {
            var result = await func1();
            return result ? await EvaluateAsync(() => func2(result), func3, func4, func5, funcResult) : Response.Create<TResult>();
        }
        ...
        {
            var result = await func1();
            return result ? await EvaluateAsync(() => func2(result), func3, func4, func5, func6, funcResult) : Response.Create<TResult>();
        }
        ...
        {
            var result = await func1();
            return result ? await EvaluateAsync(() => func2(result), func3, func4, func5, func6, func7, funcResult) : Response.Create<TResult>();
        }
        ...
        {
            var result = await func1();
            return result ? await EvaluateAsync(() => func2(result), func3, func4, func5, func6, func7, func8, funcResult) : Response.Create<TResult>();
        }
    }
}
