...
namespace ContainerExpressions.Expressions.Core
{
    internal static class Compose
    {
        ...
        {
            var result = func1();
            return result ? Evaluate(() => func2(result), func3, func4, func5, funcResult) : Response.Create<TResult>();
        }
        ...
        {
            var result = func1();
            return result ? Evaluate(() => func2(result), func3, func4, func5, func6, funcResult) : Response.Create<TResult>();
        }
        ...
        {
            var result = func1();
            return result ? Evaluate(() => func2(result), func3, func4, func5, func6, func7, funcResult) : Response.Create<TResult>();
        }
        ...
        {
            var result = func1();
            return result ? Evaluate(() => func2(result), func3, func4, func5, func6, func7, func8, funcResult) : Response.Create<TResult>();
        }
    }
}
